...
SC_MODULE(VSimpleDMVectorCache) {
  public:
    ...
    VL_SIG16(v__DOT__controller__DOT__initCtr,9,0);
    VL_SIG16(v__DOT__controller__DOT__T69,9,0);
    VL_SIG16(v__DOT__controller__DOT__T81,9,0);
    VL_SIG16(v__DOT__tagMem__DOT__T0,14,0);
    VL_SIG16(v__DOT__tagMem__DOT__T2,14,0);
    ...
    VL_SIG64(v__DOT__dataMem__DOT__cacheLines[1024],63,0);
    VL_SIG16(v__DOT__tagMem__DOT__tagStorage[1024],14,0);
