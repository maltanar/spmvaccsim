...
SC_MODULE(VSimpleDMVectorCache) {
  public:
    ...
    VL_SIG8(v__DOT__tagMem__DOT__T0,7,0);
    VL_SIG8(v__DOT__tagMem__DOT__T2,7,0);
    //char	__VpadToAlign151[1];
    VL_SIG(v__DOT__controller__DOT__initCtr,16,0);
    VL_SIG(v__DOT__controller__DOT__T69,16,0);
    VL_SIG(v__DOT__controller__DOT__T81,16,0);
    ...
    VL_SIG64(v__DOT__dataMem__DOT__cacheLines[131072],63,0);
    VL_SIG8(v__DOT__tagMem__DOT__tagStorage[131072],7,0);
