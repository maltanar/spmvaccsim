...
SC_MODULE(VSimpleDMVectorCache) {
  public:
    ...
    VL_SIG16(v__DOT__controller__DOT__initCtr,15,0);
    VL_SIG16(v__DOT__controller__DOT__T69,15,0);
    VL_SIG16(v__DOT__controller__DOT__T81,15,0);
    VL_SIG16(v__DOT__tagMem__DOT__T0,8,0);
    VL_SIG16(v__DOT__tagMem__DOT__T2,8,0);
    ...
    VL_SIG64(v__DOT__dataMem__DOT__cacheLines[65536],63,0);
    VL_SIG16(v__DOT__tagMem__DOT__tagStorage[65536],8,0);
