...
SC_MODULE(VSimpleDMVectorCache) {
  public:
    ...
    VL_SIG16(v__DOT__controller__DOT__initCtr,14,0);
    VL_SIG16(v__DOT__controller__DOT__T69,14,0);
    VL_SIG16(v__DOT__controller__DOT__T81,14,0);
    VL_SIG16(v__DOT__tagMem__DOT__T0,9,0);
    VL_SIG16(v__DOT__tagMem__DOT__T2,9,0);
    ...
    VL_SIG64(v__DOT__dataMem__DOT__cacheLines[32768],63,0);
    VL_SIG16(v__DOT__tagMem__DOT__tagStorage[32768],9,0);
