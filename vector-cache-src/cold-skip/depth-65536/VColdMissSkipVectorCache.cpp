...
VL_SC_CTOR_IMP(VColdMissSkipVectorCache)
...
#endif
 {
    ...
    v__DOT__controller__DOT__initCtr = VL_RAND_RESET_I(16);
    ...
    v__DOT__controller__DOT__T76 = VL_RAND_RESET_I(16);
    ...
    v__DOT__controller__DOT__T90 = VL_RAND_RESET_I(16);
    ...
    v__DOT__tagMem__DOT__T0 = VL_RAND_RESET_I(9);
    { int __Vi0=0; for (; __Vi0<65536; ++__Vi0) {
	    v__DOT__tagMem__DOT__tagStorage[__Vi0] = VL_RAND_RESET_I(9);
    }}
    v__DOT__tagMem__DOT__T2 = VL_RAND_RESET_I(9);
...
void VColdMissSkipVectorCache::_sequent__TOP__3(VColdMissSkipVectorCache__Syms* __restrict vlSymsp) {
    ...
    VL_SIG16(__Vdly__v__DOT__controller__DOT__initCtr,15,0);
    VL_SIG16(__Vdlyvdim0__v__DOT__dataMem__DOT__cacheLines__v0,15,0);
    VL_SIG16(__Vdlyvdim0__v__DOT__dataMem__DOT__cacheLines__v1,15,0);
    VL_SIG16(__Vdlyvdim0__v__DOT__tagMem__DOT__tagStorage__v0,15,0);
    VL_SIG16(__Vdlyvval__v__DOT__tagMem__DOT__tagStorage__v0,8,0);
	...
	__Vdlyvdim0__v__DOT__dataMem__DOT__cacheLines__v0 
	    = (0xffff & vlTOPp->__Vcellinp__v__io_writePort_writeReq_bits);
    }
	...
	if (vlTOPp->v__DOT__controller__DOT__T32) {
		...
		__Vdly__v__DOT__controller__DOT__initCtr 
		    = (0xffff & ((IData)(1) + (IData)(vlTOPp->v__DOT__controller__DOT__initCtr)));
	    } else {
	...
	__Vdlyvval__v__DOT__tagMem__DOT__tagStorage__v0 
	    = ((0 == (IData)(vlTOPp->v__DOT__controller__DOT__state))
	        ? 0 : (1 | (0x1fe & (vlTOPp->__Vcellinp__v__io_readPort_readReq_bits 
				     >> 0xf))));
...
void VColdMissSkipVectorCache::_combo__TOP__6(VColdMissSkipVectorCache__Syms* __restrict vlSymsp) {
    ...
    VL_ASSIGN_SII(24,vlTOPp->io_memRead_memReq_bits, 
		  (0xffffff & vlTOPp->__Vcellinp__v__io_readPort_readReq_bits));
    vlTOPp->v__DOT__controller__DOT__T85 = (((0xff 
    ...
    vlTOPp->v__DOT__controller__DOT__T85 = (((0xff 
						 ...
						 & (IData)(
							   ((QData)((IData)(vlTOPp->v__DOT__tagMem__DOT__T0)) 
							    >> 1)))) 
					    & (IData)((QData)(vlTOPp->v__DOT__tagMem__DOT__T0)));
    vlTOPp->v__DOT__controller__DOT__T90 = (0xffff 
...
void VColdMissSkipVectorCache::_combo__TOP__9(VColdMissSkipVectorCache__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->v__DOT__controller__DOT__T76 = (0xffff 
...
void VColdMissSkipVectorCache::_combo__TOP__12(VColdMissSkipVectorCache__Syms* __restrict vlSymsp) {
    ...
    VL_ASSIGN_SII(24,vlTOPp->io_memWrite_memWriteReq_bits, 
		  ((IData)(vlTOPp->v__DOT__controller__DOT__T56)
		    ? ((0xff0000 & ((IData)(((QData)((IData)(vlTOPp->v__DOT__tagMem__DOT__T2)) 
					     >> 1)) 
				    << 0x10)) | (0xffff 
						 & vlTOPp->__Vcellinp__v__io_readPort_readReq_bits))
		    : ((IData)(vlTOPp->v__DOT__controller__DOT__T22)
		        ? ((0xff0000 & ((IData)(((QData)((IData)(vlTOPp->v__DOT__tagMem__DOT__T2)) 
						 >> 1)) 
					<< 0x10)) | 
			   (0xffff & ((IData)(vlTOPp->v__DOT__controller__DOT__initCtr) 
				      - (IData)(1))))
		        : vlTOPp->__Vcellinp__v__io_writePort_writeReq_bits)));
    vlTOPp->v__DOT__controller__DOT__T43 = ((((0xff 
					       & (vlTOPp->__Vcellinp__v__io_readPort_readReq_bits 
						  >> 0x10)) 
					      == (0xff 
						  & (IData)(
