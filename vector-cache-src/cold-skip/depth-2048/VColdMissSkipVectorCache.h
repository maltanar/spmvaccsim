...
SC_MODULE(VColdMissSkipVectorCache) {
  public:
    ...
    VL_SIG16(v__DOT__controller__DOT__initCtr,10,0);
    VL_SIG16(v__DOT__controller__DOT__T76,10,0);
    VL_SIG16(v__DOT__controller__DOT__T90,10,0);
    VL_SIG16(v__DOT__tagMem__DOT__T0,13,0);
    VL_SIG16(v__DOT__tagMem__DOT__T2,13,0);
    ...
    VL_SIG64(v__DOT__dataMem__DOT__cacheLines[2048],63,0);
    VL_SIG16(v__DOT__tagMem__DOT__tagStorage[2048],13,0);
