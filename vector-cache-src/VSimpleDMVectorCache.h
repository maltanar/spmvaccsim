...
SC_MODULE(VSimpleDMVectorCache) {
  public:
    ...
    VL_SIG8(v__DOT__T56,0,0);
    VL_SIG8(v__DOT__T60,0,0);
    VL_SIG8(v__DOT__T63,0,0);
    VL_SIG8(v__DOT__T64,0,0);
    VL_SIG8(v__DOT__T67,0,0);
    VL_SIG8(v__DOT__T68,0,0);
    VL_SIG8(v__DOT__T72,0,0);
    VL_SIG8(v__DOT__T77,0,0);
    VL_SIG8(v__DOT__T79,0,0);
    VL_SIG8(v__DOT__T82,0,0);
    VL_SIG8(v__DOT__T84,0,0);
    VL_SIG8(v__DOT__T90,0,0);
    VL_SIG8(v__DOT__T93,0,0);
    VL_SIG8(v__DOT__T99,0,0);
